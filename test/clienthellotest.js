import { ClientHello } from "../type/clienthello.js";
...
import { SignatureSchemeList, Versions } from "@tls/extension";
...
const signatureAlgorithms = Extension.create(ExtensionType.SIGNATURE_ALGORITHMS,SignatureSchemeList.fromSchemes(SignatureScheme.ECDSA_SECP256R1_SHA256, SignatureScheme.ECDSA_SECP384R1_SHA384));
...
const clientHelloPSKBinderBack = ClientHello.from(clientHelloPSKBinder);
...
const clientHelloRecord = HexaDecimal.fromString(`16 03 01 00 c4 01 00 00 c0 03 03 cb
   34 ec b1 e7 81 63 ba 1c 38 c6 da cb 19 6a 6d ff a2 1a 8d 99 12
   ec 18 a2 ef 62 83 02 4d ec e7 00 00 06 13 01 13 03 13 02 01 00
   00 91 00 00 00 0b 00 09 00 00 06 73 65 72 76 65 72 ff 01 00 01
   00 00 0a 00 14 00 12 00 1d 00 17 00 18 00 19 01 00 01 01 01 02
